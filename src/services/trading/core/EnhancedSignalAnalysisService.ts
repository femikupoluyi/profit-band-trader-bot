...
export class EnhancedSignalAnalysisService {
  ...
  async analyzeSignalWithHealthCheck(signal: any, config: TradingConfigData): Promise<{
    ...
    try {
      ...
      console.log('🏥 Step 1: Performing system health check...');
      ...
      if (healthReport.overall === 'critical') {
        console.warn('⚠️ System health is critical - signal analysis may be unreliable');
      ...
      console.log('✅ Step 2: Validating signal with comprehensive checks...');
      ...
      console.log('🧠 Step 3: Performing enhanced signal analysis...');
